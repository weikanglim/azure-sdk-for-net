...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    /// </summary>
    internal partial class AssociationInterfaceGetByTrafficControllerAsyncCollectionResultOfT : AsyncPageable<AssociationData>
    {
        ...
        /// <summary> Initializes a new instance of AssociationInterfaceGetByTrafficControllerAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AssociationInterfaceGetByTrafficControllerAsyncCollectionResultOfT(AssociationsInterface client, string subscriptionId, string resourceGroupName, string trafficControllerName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AssociationInterfaceGetByTrafficControllerAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AssociationInterfaceGetByTrafficControllerAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AssociationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
